<template>
  ...
  <div v-if="status === 200">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="pd-breadcrumb u-s-m-b-30">
                            <ul class="pd-breadcrumb__list">
                                ...
                                <li v-for="category in product.categories" :key="category.id" class="has-separator">
                        ...
                        <div class="pd u-s-m-b-30">
                            <div class="slider-fouc pd-wrap">
                              <div id="pd-o-initiate">
                                <div v-for="image in product.images" :key="image.id" class="pd-o-img-wrap" :data-src="`/assets/images/product/${image.photo}`">
                                  <img class="u-img-fluid" :src="`/assets/images/product/${image.photo}`" :data-zoom-image="`/assets/images/product/${image.photo}`" alt="">
                                </div>
                              </div>
                              ...
                              <img class="u-img-fluid" src="" data-zoom-image="" alt=""></div>
                        ...
                        <div class="pd-detail">
                            ...
                            <div>
                                <div class="pd-detail__inline">
                                    ...
                                    <span class="pd-detail__price">{{ product.sale_price }} EGP</span>

                                    <span class="pd-detail__discount">({{percentageDiscount}}% OFF)</span><del class="pd-detail__del">{{ product.price }}</del></div>
                            </div>
                                    ...
                                    <div class="pd-detail-inline-2">
                                        <div class="u-s-m-b-15">
                                            ...
                                            <div class="input-counter">
                                                ...
                                                <span class="input-counter__minus fas fa-minus" @click="decrease()"></span>

                                                <input class="input-counter__text input-counter--text-primary-style"
                                                       type="text" v-model.number="count" data-min="1" data-max="1000">

                                                <span class="input-counter__plus fas fa-plus" @click="increase()"></span></div>
                                            <!--====== End - Input Counter ======-->
                                        </div>
                                        <div class="u-s-m-b-15">

                                            <button class="btn btn--e-brand-b-2" @click.prevent="addToCart(product)">Add to Cart</button></div>
                                    </div>
                                </form>
                            </div>
                            <div class="u-s-m-b-15">
    ...
    <div v-else>
        <p>Error fetching product. Status: {{ status }}</p>
        <p>{{ errorMessage }}</p>
    </div>
    </front-layout>
</template>
    ...
    methods: {
      ...
      fetchProduct() {
        apiClient
            ...
            .catch((error) => {
              this.errorMessage = 'Error fetching product: ' + error.message + ' ID: ' + this.$route.params.id;  // Change from this.id to this.$route.params.id
              this.status = 500;
            });
      },
    },
    computed: {
        percentageDiscount() {
            if (this.product) {
                ...
                return 0; // Default value if product data is not available yet
            }
        },
    },
};
