                    ...
                    <div class="shop-p">
                        ...
                        <div class="shop-p__collection">
                            <div class="row is-grid-active">
                                <!-- Use v-for to loop through each product -->
                                <div v-for="product in products.all_products" :key="product.id" class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product-m">
                                        <div class="product-m__thumb">
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" :href="`details/${product.id}`">
                                                <!-- Use the getImageSrc method to get the image source -->
                                                <img v-for="image in product.images" :key="image.id" class="aspect__img" :src="`/assets/images/product/${image.photo}`" alt="">
                                            </a>
                                            ...
                                            <div class="product-m__add-cart">
                                                <a class="btn--e-brand" data-modal="modal" data-modal-id="#add-to-cart" @click.prevent="addToCart(product)">Add to Cart</a>
                                            </div>
                                        </div>
                                        <div class="product-m__content">
                                            <div class="product-m__category">
                                                <!-- Use the getCategorySlugs method to get the category slugs -->
                                                <a v-for="category in product.categories" :key="category.id" :href="`/categories/${category.slug}`">{{ category.name }}</a>
                                            </div>
