<template>
  ...
  <div class="s-skeleton s-skeleton--h-600">
    <SliderComponent />
        </div>
                        ...
                        <div class="col-lg-5 col-md-5 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img collection__img" :src="`assets/images/collection/coll-5.jpg`"  alt=""></div>
                            </a>
                        </div>
                        <div class="col-lg-7 col-md-7 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--1286-890">
                                    ...
                                    <img class="aspect__img collection__img" :src="`assets/images/collection/coll-6.jpg`" alt=""></div>
                            </a></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="filter-category-container">
                                <div class="filter__category-wrapper">
                                    <button
                                        :class="['btn', 'filter__btn', 'filter__btn--style-1', { 'js-checked': all.isActive }]"
                                        type="button"
                                ...
                                <button
                                    ...
                                    :key="category.id"
                                    :class="['btn', 'filter__btn', 'filter__btn--style-1', { 'js-checked': category.isActive }]"
                                    @click="toggleButton(category)"
                                >
                                    {{ category.slug }}
                                </button>
                            </div>
                            <div class="filter__grid-wrapper u-s-m-t-30" ref="filterGridWrapper">
                                <div class="row">
                                    <div v-for="product in filteredProducts" :key="product.id" :class="['col-xl-3', 'col-lg-4', 'col-md-6', 'col-sm-6', 'u-s-m-b-30', 'filter__item skirts', getCategorySlugs(product)]">

                                    <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" :href="`details/${product.id}`">
                                                    <img v-for="image in product.images" :key="image.id" class="aspect__img" :src="`/assets/images/product/${image.photo}`" :alt="product.name" />
                                                </a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                                            <a data-modal="modal" :data-modal-id="'#quick-look-' + product.id" data-tooltip="tooltip" data-placement="top" title="Quick View"><i class="fas fa-search-plus"></i></a>
                                                        </li>
                                                        <li>
                                                            <a data-modal="modal" :data-modal-id="'#add-to-cart-' + product.id" @click.prevent="addToCart(product)" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a>
                                                        </li>
                                                        <li>
                                                            <a href="signin.html" data-tooltip="tooltip" data-placement="top"
                                                               @click.prevent="addToWishlist(product)" title="Add to Wishlist">
                                          ...
                                          <a v-for="category in product.categories" :key="category.id">
                                             {{ category.name }}
                                          </a>
                                          </span>
                                            ...
                                            <span class="product-o__price">{{ product.sale_price }} EGP
                                            <span class="product-o__discount">{{ product.price }} EGP</span>
                                          </span>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="u-s-p-b-60">
            ...
            <div class="section__content">
                <div class="container">
                    <div class="row">
                        <div v-for="product in products.deal_products" :key="product.id" class="col-lg-6 col-md-6 u-s-m-b-30">
                            <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                    ...
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            ...
                                            <li>
                                                ...
                                                <a data-modal="modal" data-modal-id="#add-to-cart" @click.prevent="addToCart(product)" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-plus-circle"></i></a></li>
                                            <li>
                                ...
                                <span class="product-o__name">
                                    ...
                                    <a :href="`details/${product.id}`">{{ product.name }}</a></span>
                                ...
                                <span class="product-o__price">$125.00
                                    ...
                                    <span class="product-o__discount">{{ product.sale_price }}</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <ul class="product-o__action-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="signin.html" data-tooltip="tooltip"
                                                       @click.prevent="addToWishlist(product)" data-placement="top" title="Add to Wishlist">
                                                        <i class="fas fa-heart"></i>
                                                    </a>
                                                </li>
                                                <li>
        ...
        <div class="u-s-p-y-60">
            ...
            <div class="section__content">
                <div class="container">
                    <div class="row">
                        <div v-for="product in products.featured_products" :key="product.id" class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">

                                  <a class="aspect aspect--bg-grey aspect--square u-d-block" :href="`details/${product.id}`">
                                    <img v-for="image in product.images" :key="image.id" class="aspect__img" :src="`/assets/images/product/${image.photo}`" :alt="product.slug">
                                  </a>
                                  ...
                                  <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            ...
                                            <li>
                                                ...
                                                <a href="signin.html" data-tooltip="tooltip" data-placement="top"
                                                   @click.prevent="addToWishlist(product)" title="Add to Wishlist"><i class="fas fa-heart"></i></a></li>
                                            <li>
                              ...
                              <span class="product-o__category" v-for="category in product.categories" :key="category.id">
                              <a>{{ category.name }}</a>
                              </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img" alt=""></div>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                    ...
                                                    <img class="aspect__img" alt=""></a></div>
            ...
            <div class="section__content">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                            <div class="service u-h-100">
                                <div class="service__icon"><i class="fas fa-s-alt"></i></div>
                                <div class="service__info-wrap">
                        ...
                        <div class="owl-carousel" id="testimonial-slider">
                            <div class="testimonial">
                                <div class="testimonial__img-wrap">
                                    ...
                                    <img class="testimonial__img" alt=""></div>
...
import apiMixin from './Apis/apiMixin.vue';
import apiCartWishlist from './Apis/apiCartWishlist.vue';
import VueCountdown from 'vue-countdown';

export default {
    mixins: [apiMixin, apiCartWishlist],
    data() {
      apiClient
        const now = new Date();
  ...
  async mounted() {
    ...
    methods: {
        toggleButton(selectedButton) {
            if (selectedButton.slug === 'all') {
                this.categories.forEach((category) => (category.isActive = false));
                this.all.isActive = !this.all.isActive;
                this.activeCategory = this.all.isActive ? 'all' : selectedButton.slug;
            }else {
                this.all.isActive = false;

                this.categories.forEach((category) => {
                    category.isActive = category.slug === selectedButton.slug;
                });

                // Set the activeCategory to the selected category's slug
                this.activeCategory = selectedButton.slug;
            }
        },
        ...
        toggleAllButton() {
            ...
            // Set "All" button to active and reset activeCategory
    ...
    computed: {
        filteredProducts() {
            if (this.activeCategory === 'all') {
                ...
                return this.products.all_products.filter((product) => {
                    console.log(product.categories.some((category) => category.slug === this.activeCategory))
                    return product.categories.some((category) => category.slug === this.activeCategory);
                });
            }
        },
    }
